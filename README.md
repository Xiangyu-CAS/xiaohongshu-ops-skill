...
- **02.27**: 接入nano banana 2生封面图，并通过图文发布流程发布 （需要gemini_api_key, 可白嫖)


## 核心能力
- [x] persona.md 小红书人设和账号定位
- [x] 爆款笔记复刻：输入爆款笔记链接，分析爆款因素，生成类似的笔记
- [x] 小红书发布流程  
- [x] 评论互动 / 自动回复  
- [ ] 数据复盘
...
| 输入爆款笔记 | 复刻生成结果 | 内容分析 |
|---|---|---|
<br><img src="./assets/爆款笔记.jpg" alt="输入的爆款笔记" width="420" /> | <br><img src="./assets/爆款笔记复刻结果.jpg" alt="复刻生成结果" width="420" /> | **Source Brief（精简拆解）**<br>- 原帖核心：“按确认键”仪式感 + 低门槛参与<br>- 标题结构：年份 + 明确目标 + 行动号召<br>- 正文结构：短文案 + 情绪价值 + 大量同主题标签<br>- 互动机制：评论区统一动作词（“确认”）形成刷屏<br>- 配图特征：多图、字重、可转发收藏型
